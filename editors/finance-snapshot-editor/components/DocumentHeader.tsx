...
import type { FinanceSnapshotDocument } from "../../document-models/finance-snapshot/gen/types.js";

interface DocumentHeaderProps {
  document: FinanceSnapshotDocument;
      ...
      <div className="flex items-center justify-between mb-4">
        {isEditing ? (
          <Form
            ...
            defaultValues={{ name: document.header.name || "Untitled Snapshot" }}
          ...
          <>
            <h1 className="text-2xl font-semibold text-gray-900">
              {document.header.name || "Untitled Snapshot"}
            </h1>
            <Button
        ...
        <div>
          ...
          <p>
            {document.header.lastModifiedAtUtcIso
              ? new Date(document.header.lastModifiedAtUtcIso).toLocaleDateString()
              : "—"}
          </p>
        </div>
      </div>
